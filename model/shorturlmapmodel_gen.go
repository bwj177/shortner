...
func (m *defaultShortUrlMapModel) FindOne(ctx context.Context, id int64) (*ShortUrlMap, error) {
	...
	err := m.QueryRowCtx(ctx, &resp, db3ShortUrlMapIdKey, func(ctx context.Context, conn sqlx.SqlConn, v any) error {
...
func (m *defaultShortUrlMapModel) FindOneByMd5(ctx context.Context, md5 sql.NullString) (*ShortUrlMap, error) {
	...
	var resp ShortUrlMap
	err := m.QueryRowIndexCtx(ctx, &resp, db3ShortUrlMapMd5Key, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v any) (i any, e error) {
...
func (m *defaultShortUrlMapModel) FindOneBySurl(ctx context.Context, surl sql.NullString) (*ShortUrlMap, error) {
	...
	var resp ShortUrlMap
	err := m.QueryRowIndexCtx(ctx, &resp, db3ShortUrlMapSurlKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v any) (i any, e error) {
